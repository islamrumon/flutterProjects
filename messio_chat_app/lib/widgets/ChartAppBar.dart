...
import 'package:messio_chat_app/config/Palette.dart';
import 'package:messio_chat_app/Assets/Assets.dart';
...
class ChatAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    var textHeading =
        TextStyle(color: Colors.white, fontSize: 20); // Text style for the name
    var textStyle =
        TextStyle(color: Colors.white70); // Text style for everything else
