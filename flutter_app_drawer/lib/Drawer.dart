...
class HiddenDrawerController{
  HiddenDrawerController({
    this.items, @required DrawerContent initialPage
}){
...
class _HiddenDrawerState extends State<HiddenDrawer>
  ...
  void initState() {
    ...
    scaleAnimation = Tween(begin: 1.0, end:0.86).animate(animationController);
  ...
  drawerItems(){
    return widget.controller.items.map((DrawerItem item){
      ...
      item.page.onMenuPressd = menuPress;
      return item;
    }).toList();
  }
  ...
  @override
  Widget build(BuildContext context) {
    widget.controller.page.onMenuPressd = menuPress;
