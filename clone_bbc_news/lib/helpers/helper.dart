...
final detailsBootomColors = Colors.grey;
...
final addsColor =Colors.grey;

final double detailspadding = 13;
//show time design
...
final relatedTopic = TextStyle(
  color: primaryColor,
  fontWeight: FontWeight.normal,
  fontSize: 16,

);
final topicColors = Colors.black12;
