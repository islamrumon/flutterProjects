...
class news{
  ...
  news({this.title,this.detials,this.fullScreen,this.icon,this.image,this.location,this.time});
}

List<news> listOfNews= <news>[
  news(title: Text("ছোট উদ্যোগে বড় পরিবর্তন",style: TextStyle(
    fontFamily: 'bangla',
    ...
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x359x1/uploads/media/2019/09/03/c866c0f080400d86ef5a22c931a7f2c2-5d6e00beb77ef.jpg'),
  ),

  news(title: Text("পুলিশের ওপর পাঁচ হামলার চারটিই দূরনিয়ন্ত্রিত বোমায়",style: TextStyle(
    fontFamily: 'bangla',
    fontWeight: FontWeight.bold,
    fontSize: 16,
  ),),
    ...
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x359x1/uploads/media/2019/09/03/a6873fb8023e521b63673048a2143dad-5d6df48ae6902.jpg'),
  ),


  news(title: Text("দলবদল: রিয়াল ছেড়ে পিএসজিতে নাভাস",style: TextStyle(
    fontFamily: 'bangla',
    fontWeight: FontWeight.bold,
    fontSize: 16,
  ),),
    ...
    location: Text("US /Canada",style: TextStyle(color: Colors.redAccent),),
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x359x1/uploads/media/2019/09/03/11ac5be137c3bceb112fec5cf361e42d-5d6e19eb2435a.jpg'),
  ),



  news(title: Text("মৃত সাঈদ যেভাবে জীবিত হয়ে ফিরে এল",style: TextStyle(
    fontFamily: 'bangla',
    fontWeight: FontWeight.bold,
    fontSize: 16,
  ),),
    ...
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x359x1/uploads/media/2019/09/03/496bafe124ff046a122411a5df7b1538-5d6daf6043b2d.jpg'),
  ),



  news(title: Text("রামুতে দোকানে আগুন, দুজনের মৃত্যু",style: TextStyle(
    fontFamily: 'bangla',
    fontWeight: FontWeight.bold,
    fontSize: 16,
  ),),
    ...
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/320x179x1/uploads/media/2017/07/08/211e4fed6541fd2350f70c479b13ad2f-59610924d6ec7.jpg'),
  ),



  news(title: Text("মমতার গ্রেপ্তার দাবি করায় মুকুলের বিরুদ্ধে এফআইআর",style: TextStyle(
    fontFamily: 'bangla',
    fontWeight: FontWeight.bold,
    fontSize: 16,
  ),),
    ...
    location: Text("US /Canada",style: TextStyle(color: Colors.redAccent),),
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x396x1/uploads/media/2019/09/03/3457e2ed1ae9604272169a557cf98575-5d6e16fcef325.jpg'),
  ),


  news(title: Text("বই পড়ি, পত্রিকা পড়ি, সুন্দর হই",style: TextStyle(
    fontFamily: 'bangla',
    fontWeight: FontWeight.bold,
    fontSize: 16,
  ),),
    ...
    location: Text("US /Canada",style: TextStyle(color: Colors.redAccent),),
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x357x1/uploads/media/2019/09/03/de0ba0ab76e5eebca80c5a5f809bdbcb-5d6df7011bde6.jpg'),
  ),


  news(title: Text("ভারতীয় চিত্রকরের তুলিতে মোশাররফ করিম",style: TextStyle(
    fontFamily: 'bangla',
    fontWeight: FontWeight.bold,
    fontSize: 16,
  ),),
    ...
    location: Text("US /Canada",style: TextStyle(color: Colors.redAccent),),
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x377x1/uploads/media/2019/09/03/ee0ef129134046c0b7058481529d3602-5d6e0f26e6b63.jpg'),
  ),


  news(title: Text("কীভাবে কাজ করেন বিল গেটস?",style: TextStyle(
    fontFamily: 'bangla',
    fontWeight: FontWeight.bold,
    fontSize: 16,
  ),),
    ...
    location: Text("US /Canada",style: TextStyle(color: Colors.redAccent),),
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x479x1/uploads/media/2015/10/28/525ea4b2174020b1976f771af4630ee5-Bill-Gates_3485125b.jpg'),
  ),
  ...
  news(title: Text("ছোট উদ্যোগে বড় পরিবর্তন",style: TextStyle(
    ...
    location: Text("US /Canada",style: TextStyle(color: Colors.redAccent),),
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: Image.network('https://paloimages.prothom-alo.com/contents/cache/images/640x359x1/uploads/media/2019/09/03/bcd0d7db273386be243a35675da6d16b-5d6dfddf3030d.jpg'),
  ),
