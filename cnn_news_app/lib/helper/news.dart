...
List<News> listOfNews= <News>[
  News(title: "Couple found dead in Kurigram",
  ...
  News(title: "Jamalpur DC Ahmed Kabir suspended",
  ...
  News(title: "Bangladesh secure final berth with thumping win",
  ...
  News(title: "Lokman has Tk 41cr stashed abroad: Rab",
  ...
  News(title:"Sociedad march on, Sevilla floored by Eibar fightback",
  ...
  News(title: "Master’s in CSE at BSMRSTU: Chairman the first student!",
  ...
  News(title: "A journey to the past with dancing Shiva",
    ...
    location: Text("US /Canada",style: TextStyle(color: Colors.redAccent),),
    time: Text("2m",style: TextStyle(color: Colors.grey),),
    image: 'https://assetsds.cdnedge.bluemix.net/sites/default/files/styles/very_big_1/public/feature/images/casino_2.jpg?itok=bQJrrbKF',
  ),


  News(title: "Four of a Buddhist family slain",
